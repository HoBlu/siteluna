...
const housePhotos = [
  ...
  "/image/gost-suite-interior.jpg",
  "/image/gost-suite-kitchen.jpg",
  "/image/gost-suite-terrace.jpg",
  "/image/gost-suite-bathroom.jpg",
  "/image/gost-suite-view.jpg"
];
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed">
              Просторный дом с современными удобствами для семей и дружных компаний
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700 mb-8">
                ...
                <p className="text-lg leading-relaxed mb-6">
                  Уютный домик из кедра, спрятанный среди величественных гор, словно теплая пристань у бурлящей реки. 20 квадратов уюта, где аромат дерева смешивается с прохладой горного воздуха. Внутри — мягкий свет, теплые полы и все, что нужно для полного расслабления: удобная двуспальная кровать, двухъярусный уголок для гостей, душ с горячей водой, мини-холодильник для свежих завтраков. А с террасы — вид, от которого замирает сердце: река, вечно бегущая к горизонту, и небо, меняющее краски с восходом и закатом. Здесь время замедляет шаг, а душа отдыхает.
                </p>
