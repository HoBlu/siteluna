      ...
      <div className="absolute inset-0 flex items-center z-20">
        <div className="max-w-7xl mx-auto w-full px-4 lg:px-8">
          ...
          >
            ...
            >
              Откройте для себя идеальное сочетание роскоши и природы. Уютные домики с отделкой из кедра, теплый бассейн, аутентичная баня и величественные пейзажи реки Катунь.
            </motion.p>
